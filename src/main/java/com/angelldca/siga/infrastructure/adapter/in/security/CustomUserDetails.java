...
public class CustomUserDetails implements UserDetails {
    ...
    public List<UserPermissionBusiness> getUserPermissionBusinesses() {
        return user.getUserPermissionBusinesses();
    }

    @Override
    public Collection<? extends GrantedAuthority> getAuthorities() {
        return user.getUserPermissionBusinesses().stream()
                .map(upb -> new SimpleGrantedAuthority(upb.getPermission().getCode()))
